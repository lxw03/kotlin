...
class AndroidExtensionsGradleImportHandler : GradleProjectImportHandler {
    ...
    override fun importByModule(facet: KotlinFacet, moduleNode: DataNode<ModuleData>) {
        ...
        commonArguments.pluginOptions = (commonArguments.pluginOptions ?: emptyArray())
                .filterTo(mutableListOf()) { !it.startsWith("plugin:$ANDROID_COMPILER_PLUGIN_ID:") } // Filter out old options
                .apply {
                    this += makePluginOption(EXPERIMENTAL_OPTION.name, moduleNode.hasAndroidExtensionsPlugin.toString())
                    this += makePluginOption(ENABLED_OPTION.name, moduleNode.isExperimental.toString())
                }.toTypedArray()
