...
internal class HashMapCacheMechanism(
    ...
    override fun loadCache() {
        ...
        iv.getfield(containerType.internalName, AbstractAndroidExtensionsExpressionCodegenExtension.PROPERTY_NAME, "Ljava/util/HashMap;")
    }
    ...
    override fun initCache() {
        ...
        iv.putfield(containerType.internalName, AbstractAndroidExtensionsExpressionCodegenExtension.PROPERTY_NAME, "Ljava/util/HashMap;")
    }
